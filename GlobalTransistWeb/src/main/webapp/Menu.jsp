...
<head>
  ...
  <meta name="description" content="This is a website for E-logistic." />
...
<body>
    ...
    <section>
    		<form action="Menu.jsp"  class="text-center" method="post">
             <input class="p-1"  type="text" name="name" maxlength="20" placeholder="Search item" required />
             <button class="btn btn-primary">Search</button>
        </form>
        <hr>
    		<%
			//we are passing name of the searched dishin var= name
		...
		%>
		<p><b>&nbsp;The price are based per Km</b> </p>
		<% 
		...
		%>
				<div class="bg-light p-2 m-2">
					...
					<p>
						<img src="GetItemPhoto?name=<%= item.get("name")  %>" height="70px" />&nbsp
						Name: <b><%= item.get("name")  %></b>
						&nbsp
						Price: <b><%= item.get("price")  %></b>&nbsp
