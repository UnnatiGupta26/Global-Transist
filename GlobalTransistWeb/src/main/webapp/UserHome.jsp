 			...
 			%>
 					<div class="bg-warning p-2 m-2">
 						<p>
 							...
 							%>
 							<a href="ChangeOrderStatus?id=<%= order.get("id") %>&email=<%= uemail %>&status=Canceled&page=UserHome" class="btn btn-sm btn-danger mx-2">Cancel</a>
 							<%	
 							}
 							%>
 						</p>
 						...
 						<p>
 							...
 							Delivery Address: <b><%= order.get("address")  %></b>
 							<hr/>
